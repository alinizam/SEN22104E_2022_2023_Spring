...
public class Example1 extends javax.swing.JFrame {
    ...
    public Example1() {
        initComponents();
        dtm.setColumnIdentifiers(new String[]{"Id","First Name","LAst Name","Doktor Id"});
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cbDoctors, 0, 129, Short.MAX_VALUE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        EntityManager em=emf.createEntityManager();
        Patiens p=new Patiens(Integer.parseInt(txtId.getText())
                             ,txtFirstName.getText()
                             ,txtLastName.getText()
                             ,((Doctor)cbDoctors.getSelectedItem()).getDoctorId());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        dtm.setRowCount(0);
        EntityManager em=emf.createEntityManager();
        Query q=em.createQuery("Select p From Patiens p WHERE p.doctorId=:p_doctor_id");
        q.setParameter("p_doctor_id", ((Doctor)cbDoctors.getSelectedItem()).getDoctorId() );
        List<Patiens> patients=q.getResultList();
        for (Patiens p : patients) {
            dtm.addRow(new Object[]{p.getPatientid(),p.getFirstName(),p.getLastName(),p.getDoctorId()});
        }
        em.close();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int patientId=(Integer)jTable1.getValueAt(jTable1.getSelectedRow(), 0);
        EntityManager em=emf.createEntityManager();
        em.getTransaction().begin();
        Patiens p=em.find(Patiens.class, patientId);
        em.remove(p);
        em.getTransaction().commit();
