 ...
 * @author ali.nizam
 */
public class Example1_1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtOperation.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(txtOperation, javax.swing.GroupLayout.PREFERRED_SIZE, 330, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(181, 181, 181))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        /* First Solution more generic
        Object o=evt.getSource();
        JButton b=(JButton)o;
        txtOperation.setText(txtOperation.getText()+b.getText());*/

       /* Second Solution*/
        txtOperation.setText(txtOperation.getText()+evt.getActionCommand());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Example1_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Example1_1().setVisible(true);
            }
        });
    }
